package com.longjunhao.inputmethoddemo.views;
...
import com.longjunhao.inputmethoddemo.MyApp;
import com.longjunhao.inputmethoddemo.views.Keyboard.Key;
 ...
 *
 * This class was deprecated in API level 29 (Android10).
 */
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, com.android.internal.R.styleable.KeyboardView, defStyleAttr, defStyleRes);
        ...
        mBackgroundDimAmount = a.getFloat(com.android.internal.R.styleable.Theme_backgroundDimAmount, 0.5f);
        ...
        if (mAccessibilityManager.isEnabled()) {
            ...
            switch (code) {
                case Keyboard.KEYCODE_ALT:
                    text = MyApp.getContext().getString(R.string.keyboardview_keycode_alt);
                    break;
                case Keyboard.KEYCODE_CANCEL:
                    text = MyApp.getContext().getString(R.string.keyboardview_keycode_cancel);
                    break;
                case Keyboard.KEYCODE_DELETE:
                    text = MyApp.getContext().getString(R.string.keyboardview_keycode_delete);
                    break;
                case Keyboard.KEYCODE_DONE:
                    text = MyApp.getContext().getString(R.string.keyboardview_keycode_done);
                    break;
                case Keyboard.KEYCODE_MODE_CHANGE:
                    text = MyApp.getContext().getString(R.string.keyboardview_keycode_mode_change);
                    break;
                case Keyboard.KEYCODE_SHIFT:
                    text = MyApp.getContext().getString(R.string.keyboardview_keycode_shift);
                    break;
                case '\n':
                    text = MyApp.getContext().getString(R.string.keyboardview_keycode_enter);
                    break;
                default:
